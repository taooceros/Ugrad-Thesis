...
This chapter will introduce different designs of delegation styled locks that
are adopt the concept of usage fairness. We start with the banning strategy,
