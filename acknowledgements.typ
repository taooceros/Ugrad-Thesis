...
I want to thank my systems friends, Thomason Zhao and Yibo Wu. Concurrency has been a field that is very hard to debug. Once I faced a bug#footnote[a very stupid memory bug, but sometimes those are the hardest to debug.] that I could not resolve for weeks. Without their help, it might take me months. I also want to thank many of my other CS friends, Boyuan Zou, Ruixuan Tu, Zhilin Du, Lingrong Cai and Feijun Chen. It has been incredibly interesting to have you all in my undergraduate life. I also want to thank Lulu Jin for the various valuable help with my writing.
